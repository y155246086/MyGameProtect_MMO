...
function Network.Start() 
	...
	Event.AddListener(Protocal.P_GC_GAME_CREATE_ROLE,this.OnCreateRole);
end
--PBLUA登录--
function Network.OnCreateRole(buffer)
	log("DDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD");
	--local protocal = buffer:ReadByte();
	local data = buffer:ReadBuffer();

    local msg = login_pb.CreateRoleRes();
    msg:ParseFromString(data);
	log('Network.OnLogin:  msg:>'..msg.result);
end
--Socket消息--
