...
\shadowimage{navmeshgraph_inspector.png}
	...
	,IRaycastableGraph 
	{
		...
		void GenerateNodes (Vector3[] vectorVertices, int[] triangles, out Vector3[] originalVertices, out Int3[] vertices) {
			...
			UnityEngine.Profiler.BeginSample ("Init");
			...
			UnityEngine.Profiler.BeginSample ("Hashing");
			...
			UnityEngine.Profiler.EndSample ();
			UnityEngine.Profiler.BeginSample ("Constructing Nodes");
			...
			UnityEngine.Profiler.BeginSample ("Connecting Nodes");
			...
			UnityEngine.Profiler.EndSample ();
			UnityEngine.Profiler.BeginSample ("Rebuilding BBTree");
